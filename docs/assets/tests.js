...
define('ember-alpha/tests/app.lint-test', [], function () {
  'use strict';
...
define('ember-alpha/tests/integration/components/people-list-test', ['qunit', 'ember-qunit', '@ember/test-helpers'], function (_qunit, _emberQunit, _testHelpers) {
  'use strict';
...
define('ember-alpha/tests/test-helper', ['ember-alpha/app', 'ember-alpha/config/environment', '@ember/test-helpers', 'ember-qunit'], function (_app, _environment, _testHelpers, _emberQunit) {
  'use strict';
...
define('ember-alpha/tests/tests.lint-test', [], function () {
  'use strict';
...
define('ember-alpha/tests/unit/routes/scientists-test', ['qunit', 'ember-qunit'], function (_qunit, _emberQunit) {
  'use strict';
...
require('ember-alpha/tests/test-helper');
